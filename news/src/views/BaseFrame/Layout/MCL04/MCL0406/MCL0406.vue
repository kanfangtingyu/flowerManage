...
export default {
  ...
  created() {
    this.cardId = CARD_ID.MCL0406
    this.pageID = OPTION_ID.MCL0406A
  },
  computed: {
    backListChange() {
      if (this.maincardType === '契約一覧' && this.srvcKindCode !== '  ') {
        return MCL04CONS.SERVICE_LIST
      } else {
        return MCL04CONS.EKIMU_LIST
      }
    }
  }
}
