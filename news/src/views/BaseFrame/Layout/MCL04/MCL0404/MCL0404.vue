<template>
  <div ref="mcl04" class="mcl04 mcl0404">
    <div class="header">
      <div class="title">
        <span @click="onBackList()" class="cursor">
          <svg-icon class="title-Img" icon-class="GobackButton"></svg-icon>
          <span class="spanLine title-Left">役務一覽</span>
        </span>
      </div>
...
export default {
  ...
  created() {
    this.cardId = CARD_ID.MCL0404
    this.pageID = OPTION_ID.MCL0404A
  }
}
</script>
<style>
.mcl0404 .keiyaku-number {
  color: #4a4a4a;
}
</style>
